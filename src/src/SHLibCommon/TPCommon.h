...
inline ACE_Log_Output::ACE_Log_Output (void)
  : output_file_ (0)
{
#if !defined (ACE_LACKS_IOSTREAM_TOTALLY)
...
inline OFSTREAM *
ACE_Log_Output::output_file (void)
{
  return this->output_file_;
}

inline int
ACE_Log_Output::set_output (const ACE_TCHAR *filename, int append)
{
...
typedef ACE_Singleton<ACE_Log_Output, ACE_Null_Mutex> ace_file_stream;

#if defined (ACE_HAS_EXPLICIT_TEMPLATE_INSTANTIATION)
template class ACE_Singleton<ACE_Log_Output, ACE_Null_Mutex>;
#elif defined (ACE_HAS_TEMPLATE_INSTANTIATION_PRAGMA)
#pragma instantiate ACE_Singleton<ACE_Log_Output, ACE_Null_Mutex>
#elif defined (__GNUC__) && defined (_AIX)
template ACE_Singleton<ACE_Log_Output, ACE_Null_Mutex> *
  ACE_Singleton<ACE_Log_Output, ACE_Null_Mutex>::singleton_;
