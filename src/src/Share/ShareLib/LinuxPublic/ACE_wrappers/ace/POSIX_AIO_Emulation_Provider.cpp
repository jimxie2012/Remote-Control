 ...
 *****************************************************************
 */
ACE_POSIX_AIO_Emulation_Provider::~ACE_POSIX_AIO_Emulation_Provider ()
{
}
...
// *************************************************************
int
ACE_POSIX_AIO_Emulation_Provider::get_supported_operations_mask () const
{
...
int 
ACE_POSIX_AIO_Emulation_Provider::register_handle (ACE_HANDLE handle,
...
int 
ACE_POSIX_AIO_Emulation_Provider::unregister_handle (ACE_HANDLE handle)
{
...
int
ACE_POSIX_AIO_Emulation_Provider::cancel_all
...
int
ACE_POSIX_AIO_Emulation_Provider::cancel_aio
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    size_t num_files = this->repository_.size ();
...
int 
ACE_POSIX_AIO_Emulation_Provider::start_aio 
    (ACE_POSIX_Asynch_Result *result,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    int rc;
    ...
    //if (original.op_code () == ACE_Asynch_Result::OP_CONNECT)
    //{
...
// *************************************************************
int
ACE_POSIX_AIO_Emulation_Provider::get_completed_aio 
...
// *************************************************************
bool  
ACE_POSIX_AIO_Emulation_Provider::begin_aio_wait 
      (ACE_Time_Value * wait_time,
       Guard_Monitor &  leader_guard,
       ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
// *************************************************************
int  
ACE_POSIX_AIO_Emulation_Provider::finish_aio_completions (
                    ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    for(;;)
    {
...
// *************************************************************
int 
ACE_POSIX_AIO_Emulation_Provider::get_interest(ACE_HANDLE handle)
{
    // lock FD_Info access 
    // do not create FD_Info if there is no such element
...
// *************************************************************
int
ACE_POSIX_AIO_Emulation_Provider::execute 
    (ACE_POSIX_AIO_FD_Info * info,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    if (info == 0)
