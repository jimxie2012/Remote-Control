 ...
 * details.
 */
class ACE_Export ACE_Proactor_Impl
{
public:
  /// Virtual destruction.
  ...
  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Read_Stream_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Write_Stream_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Read_Dgram_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Write_Dgram_Result & result) = 0;
    
  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Accept_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Connect_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Transmit_File_Result & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_Timer & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Wakeup_Completion & result) = 0;

  virtual ACE_Asynch_Result_Impl *
    create_result_impl (const ACE_Asynch_User_Result & result) = 0;

  virtual int cancel_aio (ACE_HANDLE h) = 0;
  virtual int cancel_aio (ACE_Handler * handler) = 0;
