 ...
 *****************************************************************
 */
ACE_POSIX_AIO_Event_Poll_Provider::~ACE_POSIX_AIO_Event_Poll_Provider()
{
    fini ();
}
...
int 
ACE_POSIX_AIO_Event_Poll_Provider::get_specific_flags () const
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::init ()
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::fini ()
{
    if (this->fd_poller_ != ACE_INVALID_HANDLE)
    {
...
int
ACE_POSIX_AIO_Event_Poll_Provider::interrupt ()
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::declare_interest (ACE_POSIX_AIO_FD_Info * info,
                                                     int interest,
                                                     int remain_mask)
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::clear_interest (ACE_POSIX_AIO_FD_Info * info)
{
    int fd = info->get_handle();
...
// *****************************************************************
int
ACE_POSIX_AIO_Event_Poll_Provider::declare_interest_i (int fd)
{
    ...
    if (rc < 0)
    {
        ...
        default:
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_LIB_TEXT("(%t) ACE_POSIX_AIO_Event_Poll_Strategy::declare_interest : %p\n"),
...
int
ACE_POSIX_AIO_Event_Poll_Provider::clear_interest_i (int fd)
{
    ...
    if (rc < 0)
    {
        ...
        default:
          ACE_ERROR_RETURN ((LM_ERROR,
            ACE_LIB_TEXT("(%t) ACE_POSIX_AIO_Event_Poll_Strategy::clear_interest : %p\n"),
            ACE_LIB_TEXT("epoll_ctl failed")),
            -1);
        }
    }
...
int
ACE_POSIX_AIO_Event_Poll_Provider::poll_ready_fd (Guard_Monitor &  leader_guard,
                                           int & ready_mask,
                                           int & remain_mask)
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::get_ready_fd (ACE_Time_Value * wait_time,
...
ACE_HANDLE
ACE_POSIX_AIO_Event_Poll_Provider::find_next_ready_fd (int & ready_mask,
                                                       int & remain_mask)
{
...
int
ACE_POSIX_AIO_Event_Poll_Provider::wait_for_ready_fd (ACE_Time_Value * wait_time)
{
    ACE_TRACE ("ACE_POSIX_AIO_Event_Poll_Provider::wait_for_ready_fd");
