...
{
public:
  static void release (ACE_Asynch_Result_Impl *result_impl);
  ...
  ACE_Asynch_Result_Impl (ACE_Allocator *allocator,
                          void          *area);
...
private:
  ...
  ACE_Asynch_Result_Impl (const ACE_Asynch_Result_Impl& other);
  ACE_Asynch_Result_Impl & operator = (const ACE_Asynch_Result_Impl& other);
...
inline void
ACE_Asynch_Result_Impl::set_completion (ssize_t nbytes, u_long errcode)
{
