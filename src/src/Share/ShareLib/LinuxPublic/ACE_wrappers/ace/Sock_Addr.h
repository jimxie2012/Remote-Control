 ...
 */
//=============================================================================
#ifndef ACE_SOCK_ADDR_H 
#define ACE_SOCK_ADDR_H
...
class ACE_Export ACE_Sock_Addr
{
public:
    ...
    ~ACE_Sock_Addr ();
    ACE_Sock_Addr (int type = AF_ANY);
    ACE_Sock_Addr (const ACE_Sock_Addr & other);
    ACE_Sock_Addr (const ACE_Addr& other);
    ACE_Sock_Addr (sockaddr *addr, int size);
    ...
    void set (const ACE_Sock_Addr & other);
