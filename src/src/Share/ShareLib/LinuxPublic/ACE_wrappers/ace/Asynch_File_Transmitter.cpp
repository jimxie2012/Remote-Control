...
// ************************************************************
// ACE_Asynch_File_Transmitter
// ************************************************************
ACE_Asynch_File_Transmitter::ACE_Asynch_File_Transmitter
      (Callback & cb,
...
ACE_Asynch_File_Transmitter::~ACE_Asynch_File_Transmitter (void)
{
}

ACE_Asynch_Transmit_File_Result &
ACE_Asynch_File_Transmitter::get_original_result ()
{
  return this->original_;
}

int
ACE_Asynch_File_Transmitter::check_params (void)
{
  ...
  if (this->remain_bytes_ ==  (size_t)-1)
    ACE_ERROR_RETURN ((LM_ERROR,
        ACE_TEXT("ACE_Asynch_File_Transmitter: filesize failed\n")),
        -1);
  ...
  if (this->file_offset_ > this->remain_bytes_)
    ACE_ERROR_RETURN ((LM_ERROR,
        ACE_TEXT("ACE_Asynch_File_Transmitter: File size is less than offset\n")),
        1);
...
int
ACE_Asynch_File_Transmitter::transmit (void)
{
  ...
  if (proactor == 0)
    {
      ...
      if (proactor == 0)
        ACE_ERROR_RETURN ((LM_ERROR,
            "ACE_Asynch_File_Transmitter: no proactor given\n"),
             -1);
    }
  ...
  if (this->rf_.open (*this,
                      ...
                      proactor) == -1)
    ACE_ERROR_RETURN ((LM_ERROR,
                       "ACE_Asynch_File_Transmitter: read_file open failed\n"),
                      -1);
  ...
  if (this->ws_.open (*this,
                      ...
                      proactor) == -1)
    ACE_ERROR_RETURN ((LM_ERROR,
                       "ACE_Asynch_File_Transmitter: write_stream open failed\n"),
                      -1);
...
void
ACE_Asynch_File_Transmitter::handle_write_stream (const ACE_Asynch_Write_Stream::Result &result)
{
      ...
      else
        {
          ...
          switch (act)
            ...
            default:
              // @@ Handle this error.
              ACE_ERROR ((LM_ERROR,
                  ACE_TEXT("ACE_Asynch_File_Transmitter: Unexpected act\n")));
...
void
ACE_Asynch_File_Transmitter::handle_read_file (const ACE_Asynch_Read_File::Result &result)
{
  // Check for error
  u_long error = result.error();
  if (error != 0)
...
int
ACE_Asynch_File_Transmitter::transmit_header (void)
{
...
int
ACE_Asynch_File_Transmitter::transmit_trailer (void)
{
    ACE_Asynch_Transmit_File::Header_And_Trailer * header_and_trailer =
        this->original_.header_and_trailer();
...
int
ACE_Asynch_File_Transmitter::initiate_write_stream (
                              ...
                              const void        *act)
{
  if (this->ws_.write (mb,
                       ...
                       this->original_.signal_number ()) == -1)
    {
      ...
      ACE_ERROR_RETURN ((LM_ERROR,
        ACE_TEXT("ACE_Asynch_File_Transmitter: write stream failed\n")),
        -1);
    }
...
int
ACE_Asynch_File_Transmitter::initiate_read_file (void)
{
  ...
  if (this->rf_.read (this->mb_,
                      ...
                      this->original_.signal_number ()) == -1)
    {
      ...
      ACE_ERROR_RETURN ((LM_ERROR,
            ACE_TEXT("ACE_Asynch_File_Transmitter: read file failed\n")),
            -1);
    }
    return 0;
}
