...
//=============================================================================
/**
 *  @file    ACE_POSIX_AIO_Kqueue_Strategy.h
 *
 *  $Id:  $
 *
...
#ifndef ACE_POSIX_AIO_KQUEUE_PROVIDER_H 
#define ACE_POSIX_AIO_KQUEUE_PROVIDER_H 
...
/**
 * @class ACE_POSIX_AIO_Kqueue_Provider
 *
 */

class ACE_Export ACE_POSIX_AIO_Kqueue_Provider : 
...
public:
    ...
    ACE_POSIX_AIO_Kqueue_Provider (const ACE_POSIX_AIO_Config & config);
    virtual ~ACE_POSIX_AIO_Kqueue_Provider();
...
#endif //ACE_POSIX_AIO_KQUEUE_PROVIDER_H 
