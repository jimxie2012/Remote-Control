 ...
 *****************************************************************
 */
ACE_POSIX_AIO_Poll_Provider::~ACE_POSIX_AIO_Poll_Provider()
{
    fini ();
}
...
int 
ACE_POSIX_AIO_Poll_Provider::get_specific_flags () const
{
    // return 0;
...
int 
ACE_POSIX_AIO_Poll_Provider::init ()
{
    if (this->poll_fds_ == 0)
    {
...
int 
ACE_POSIX_AIO_Poll_Provider::fini ()
{
...
int
ACE_POSIX_AIO_Poll_Provider::interrupt ()
{
...
// *****************************************************************
int
ACE_POSIX_AIO_Poll_Provider::declare_interest (ACE_POSIX_AIO_FD_Info * info,
                                               int interest,
                                               int remain_mask)
{
...
int
ACE_POSIX_AIO_Poll_Provider::clear_interest (ACE_POSIX_AIO_FD_Info * info)
{
    ACE_UNUSED_ARG (info);
    return 0;
}
...
int
ACE_POSIX_AIO_Poll_Provider::poll_ready_fd (Guard_Monitor &  leader_guard,
                                           int & ready_mask,
                                           int & remain_mask)
{
...
int
ACE_POSIX_AIO_Poll_Provider::get_ready_fd (ACE_Time_Value * wait_time,
...
ACE_HANDLE
ACE_POSIX_AIO_Poll_Provider::find_next_ready_fd (int & ready_mask,
                                                 int & remain_mask)
{
...
int
ACE_POSIX_AIO_Poll_Provider::wait_for_ready_fd (ACE_Time_Value * wait_time)
{
    ACE_TRACE ("ACE_POSIX_AIO_Poll_Provider::wait_for_ready_fd");
