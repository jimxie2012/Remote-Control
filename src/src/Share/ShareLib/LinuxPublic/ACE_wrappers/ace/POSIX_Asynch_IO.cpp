...
ACE_POSIX_Asynch_Result::get_link () const
{
    return & this->link_;
}
...
void 
ACE_POSIX_Asynch_Result::build_aiocb()
{
  ACE_Asynch_Result& original = this->get_original_result();
...
int
ACE_POSIX_Asynch_Result::post_impl ()
{
  return this->posix_proactor ()->post (this);
}

int
ACE_POSIX_Asynch_Result::start_impl ()
{
...
ACE_POSIX_Asynch_Read_Stream_Result::ACE_POSIX_Asynch_Read_Stream_Result 
    (ACE_Allocator *allocator,
     ...
     ACE_POSIX_Proactor *posix_proactor)
: ACE_POSIX_Asynch_Result (allocator, area,  original, posix_proactor)
, original_               (original)
{
}
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Read_Stream_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Read_Stream_Result::execute  ()
{ 
    ...
    if (original_.op_code () == ACE_Asynch_Result::OP_READ_FILE)
    {
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Write_Stream_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Write_Stream_Result::execute  ()
{ 
    int     rc = 2;  //    finished and next op possible
    int     aio_error = 0;
    ssize_t aio_return = 0;
    ...
    if (original_.op_code () == ACE_Asynch_Result::OP_WRITE_FILE)
    {
        off_t pos = ACE_OS::lseek (original_.handle (),
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Read_Dgram_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Read_Dgram_Result::execute ()
{ 
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Write_Dgram_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Write_Dgram_Result::execute ()
{
    // to be compatible with original ACE version
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Accept_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Accept_Result::execute ()
{ 
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Connect_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_POSIX_Asynch_Connect_Result::execute ()
{ 
...
int
ACE_POSIX_Asynch_Connect_Result::start_impl ()
{ 
...
ACE_Asynch_Result &
ACE_POSIX_Asynch_Transmit_File_Result::get_original_result () 
{
  return this->transmitter_.get_original_result ();
}

int
ACE_POSIX_Asynch_Transmit_File_Result::execute ()
{ 
  return -1;
}

int
ACE_POSIX_Asynch_Transmit_File_Result::start_impl ()
{
...
void
ACE_POSIX_Asynch_Transmit_File_Result::on_complete (
               ACE_Asynch_File_Transmitter& transmitter)
{
