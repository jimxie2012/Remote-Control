...
// Asynch_Result
// ***********************************************************************
ACE_Asynch_Result::ACE_Asynch_Result (int                op_code,
                                      int                op_flags,
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
...
void
ACE_Asynch_Result::move_wr_ptrs ()
{
...
void
ACE_Asynch_Result::move_rd_ptrs ()
{
  ACE_Message_Block* mb = this->get_message_block_ptr();
  if (mb == 0)
      return;  //  Direct Buffers 
...
ACE_Asynch_Read_Stream_Result::ACE_Asynch_Read_Stream_Result (
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
                                      const Buffer_Info&  buf_info,
                                      size_t             bytes_requested,
                                      ...
                                      int                signal_number,
                                      int                op_flags)
  : ACE_Asynch_Result (OP_READ_STREAM ,
...
ACE_Asynch_Read_Stream_Result::ACE_Asynch_Read_Stream_Result (
                                      ...
                                      int                signal_number,
                                      int                op_flags)
  : ACE_Asynch_Result (OP_READ_FILE,
                       op_flags & (FLG_IOVECT | FLG_EXACTLY_BYTES),
                       handler,
                       handle,
                       buf_info,
...
int
ACE_Asynch_Read_Stream_Result::dispatch (void)
{
  // Appropriately move the pointers in the message block.
  // wr_ptr after read !
  this->move_wr_ptrs ();
...
// ***********************************************************************
ACE_Asynch_Write_Stream_Result::ACE_Asynch_Write_Stream_Result (
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
                                      const Buffer_Info& buf_info,
                                      size_t             bytes_requested,
                                      ...
                                      int                signal_number,
                                      int                op_flags)
  : ACE_Asynch_Result (OP_WRITE_STREAM,
                       op_flags & (FLG_IOVECT | FLG_EXACTLY_BYTES),
                       handler,
                       handle,
                       buf_info,
...
ACE_Asynch_Write_Stream_Result::ACE_Asynch_Write_Stream_Result (
                                      ...
                                      int                signal_number,
                                      int                op_flags)
  : ACE_Asynch_Result (OP_WRITE_FILE,
                       op_flags & (FLG_IOVECT | FLG_EXACTLY_BYTES),
                       handler,
                       handle,
                       buf_info,
...
int
ACE_Asynch_Write_Stream_Result::dispatch (void)
{
  // Appropriately move the pointers in the message block.
  // rd_ptr after write !
  this->move_rd_ptrs ();
...
ACE_Asynch_Accept_Result::ACE_Asynch_Accept_Result (
                                      ACE_Handler       *handler,
...
void
ACE_Asynch_Accept_Result::set_accept_handle (ACE_HANDLE  accept_handle)
{
  this->accept_handle_ = accept_handle;
}

void
ACE_Asynch_Accept_Result::update_addresses (sockaddr   *local_addr,
                                            int         local_size,
...
void
ACE_Asynch_Accept_Result::update_addresses (ACE_HANDLE handle)
{
...
int
ACE_Asynch_Accept_Result::dispatch (void)
{
    // Appropriately move the pointers in the message block.
    // wr_ptr after read !
    this->move_wr_ptrs ();
...
ACE_Asynch_Connect_Result::ACE_Asynch_Connect_Result (
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
...
int
ACE_Asynch_Connect_Result::dispatch (void)
{
    // Appropriately move the pointers in the message block.
    // rd_ptr after write !
    this->move_rd_ptrs ();
...
ACE_Asynch_Read_Dgram_Result::ACE_Asynch_Read_Dgram_Result (
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
                                      const Buffer_Info& buf_info,
                                      size_t             bytes_requested,
                                      ...
                                      int                signal_number,
                                      int                scatter_flags)
  : ACE_Asynch_Result (OP_READ_DGRAM,
...
int
ACE_Asynch_Read_Dgram_Result::dispatch (void)
{
  // Appropriately move the pointers in the message block.
  // wr_ptr after read !
  this->move_wr_ptrs ();
...
ACE_Asynch_Write_Dgram_Result::ACE_Asynch_Write_Dgram_Result (
                                      ACE_Handler       *handler,
                                      ACE_HANDLE         handle,
                                      const ACE_Addr &   remote_sap,
                                      const Buffer_Info&  buf_info,
                                      ...
                                      int                signal_number,
                                      int                gather_flags)
  : ACE_Asynch_Result (OP_WRITE_DGRAM,
...
int
ACE_Asynch_Write_Dgram_Result::dispatch (void)
{
  // Appropriately move the pointers in the message block.
  // rd_ptr after write !
  this->move_rd_ptrs ();
...
// ***********************************************************************
ACE_Asynch_Transmit_File_Result::ACE_Asynch_Transmit_File_Result (
                                   ACE_Handler        *handler,
                                   ACE_HANDLE          socket,
                                   ACE_HANDLE          file,
                                   ...
                                   int                 priority,
                                   int                 signal_number)
  : ACE_Asynch_Result  (OP_TRANSMIT_FILE,
                        0,
                        handler,
                        socket,
                        Buffer_Info (0),
...
int
ACE_Asynch_Transmit_File_Result::dispatch()
{
  // Call the application handler.
...
// ***********************************************************************
ACE_Asynch_Transmit_File_Result::
...
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::~Header_And_Trailer (void)
{
}
...
ACE_Message_Block *
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::header (void) const
{
  return this->header_;
}

void
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::header (ACE_Message_Block *message_block)
{
  this->header_ = message_block;
}

size_t
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::header_bytes (void) const
{
  return this->header_bytes_;
}

void
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::header_bytes (size_t bytes)
{
  this->header_bytes_ = bytes;
}

ACE_Message_Block *
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::trailer (void) const
{
  return this->trailer_;
}

void
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::trailer (ACE_Message_Block *message_block)
{
  this->trailer_ = message_block;
}

size_t
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::trailer_bytes (void) const
{
  return this->trailer_bytes_;
}

void
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::trailer_bytes (size_t bytes)
{
  this->trailer_bytes_ = bytes;
}

ACE_LPTRANSMIT_FILE_BUFFERS
ACE_Asynch_Transmit_File_Result::Header_And_Trailer::transmit_buffers (void)
{
...
// Asynch Timer
// ******************************************************************
ACE_Asynch_Timer::ACE_Asynch_Timer (ACE_Handler          *handler,
                                    const ACE_Time_Value &tv,
                                    const void           *act,
                                    const void           *completion_key,
                                    int                   priority,
                                    int                   signal_number)
  : ACE_Asynch_Result  (OP_TIMER,
                        FLG_FAKE_RESULT,
                        handler,
...
ACE_Asynch_Timer::~ACE_Asynch_Timer ()
{
}

int
ACE_Asynch_Timer::dispatch()
{
  // Call the application handler.
...
// Wakeup Completion
// ******************************************************************
ACE_Wakeup_Completion::ACE_Wakeup_Completion (
                                    ACE_Handler          *handler,
                                    const void           *act,
                                    const void           *completion_key,
                                    int                   priority,
                                    int                   signal_number)
  : ACE_Asynch_Result  (OP_WAKEUP,
                        FLG_FAKE_RESULT,
                        handler,
                        ACE_INVALID_HANDLE, // handle
                        Buffer_Info (0),     // message_block_ptr,
...
int
ACE_Wakeup_Completion::dispatch()
{
  // Call the application handler.
...
//  User Result
// ******************************************************************
ACE_Asynch_User_Result::ACE_Asynch_User_Result (
                          ACE_Handler        *handler,
                          ACE_HANDLE          handle,
                          const Buffer_Info&   buf_info,
                          size_t              bytes_requested,
...
int
ACE_Asynch_User_Result::dispatch()
{
  // Call the application handler.
...
int
ACE_Asynch_Operation::close (void)
{
  //if (this->handle_ != ACE_INVALID_HANDLE && this->proactor_ != 0)
  //  {
  //    ACE_Proactor_Impl * impl = this->proactor_->implementation ();
  //    if (impl != 0)
...
int
ACE_Asynch_Read_Stream::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_READ_STREAM;
}

int
ACE_Asynch_Read_Stream::read (const Buffer_Info& buf_info,
                              size_t             bytes_to_read,
                              const void        *act,
                              int                priority,
                              int                signal_number)
{
  ACE_Asynch_Read_Stream_Result result(this->handler_,
                                       this->handle_,
                                       buf_info,
                                       bytes_to_read,
                                       act,
                               ...
                               int                signal_number)
{
  ACE_Asynch_Read_Stream_Result result(this->handler_,
                                       ...
                                       priority,
                                       signal_number,
                                       ACE_Asynch_Result::FLG_IOVECT);

  return this->proactor_->start (result);
}

int
ACE_Asynch_Read_Stream::read_n (const Buffer_Info& buf_info,
                              size_t             bytes_to_read,
                              const void        *act,
                              int                priority,
                              int                signal_number)
{
  ACE_Asynch_Read_Stream_Result result(this->handler_,
                                       ...
                                       priority,
                                       signal_number,
                                       ACE_Asynch_Result::FLG_EXACTLY_BYTES);

  return this->proactor_->start (result);
}
  
int
ACE_Asynch_Read_Stream::read_n (ACE_Message_Block& message_block,
                              size_t             bytes_to_read,
                              const void        *act,
                              int                priority,
                              int                signal_number)
...
int
ACE_Asynch_Read_Stream::readv_n (ACE_Message_Block& message_block,
                               size_t             bytes_to_read,
                               const void        *act,
                               int                priority,
                               int                signal_number)
...
int
ACE_Asynch_Write_Stream::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_WRITE_STREAM;
}
...
ACE_Asynch_Write_Stream::write (ACE_Message_Block& message_block,
                                ...
                                int                signal_number)
{
  ACE_Asynch_Write_Stream_Result result(this->handler_,
                                       this->handle_,
                                       Buffer_Info (message_block),
                                       bytes_to_write,
                                       act,
...
int
ACE_Asynch_Write_Stream::write (const Buffer_Info& buf_info,
                                size_t             bytes_to_write,
                                const void        *act,
                                int                priority,
                                int                signal_number)
...
int
ACE_Asynch_Write_Stream::write_n (ACE_Message_Block& message_block,
                                size_t             bytes_to_write,
                                const void        *act,
                                int                priority,
                                int                signal_number)
...
int
ACE_Asynch_Write_Stream::write_n (const Buffer_Info& buf_info,
                                size_t             bytes_to_write,
                                const void        *act,
                                int                priority,
                                int                signal_number)
...
int
ACE_Asynch_Write_Stream::writev_n (ACE_Message_Block& message_block,
                              size_t             bytes_to_write,
                              const void        *act,
                              int                priority,
                              int                signal_number)
...
int
ACE_Asynch_Read_File::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_READ_FILE;
}
...
ACE_Asynch_Read_File::read (ACE_Message_Block& message_block,
                            ...
                            int                signal_number)
{
  ACE_Asynch_Read_File_Result result(this->handler_,
                                     this->handle_,
                                     Buffer_Info (message_block),
                                     bytes_to_read,
                                     offset,
...
int
ACE_Asynch_Read_File::read (const Buffer_Info& buf_info,
                            size_t             bytes_to_read,
                            u_long             offset,
                            u_long             offset_high,
                            const void        *act,
...
int
ACE_Asynch_Write_File::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_WRITE_FILE;
}
...
ACE_Asynch_Write_File::write (ACE_Message_Block& message_block,
                              ...
                              int                signal_number)
{
  ACE_Asynch_Write_File_Result result(this->handler_,
                                     this->handle_,
                                     Buffer_Info (message_block),
                                     bytes_to_write,
                                     offset,
...
int
ACE_Asynch_Write_File::write (const Buffer_Info& buf_info,
                              size_t             bytes_to_write,
                              u_long             offset,
                              u_long             offset_high,
                              const void        *act,
...
int
ACE_Asynch_Accept::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_ACCEPT;
}
...
ACE_Asynch_Accept::accept(ACE_Message_Block &message_block,
                          ...
                          int                signal_number)
{
  ACE_Asynch_Accept_Result result (this->handler_,
                                   this->handle_,
                                   Buffer_Info (message_block),
                                   bytes_to_read,
                                   act,
...
int
ACE_Asynch_Accept::accept(const Buffer_Info& buf_info,
                          size_t             bytes_to_read,
                          const void        *act,
                          int                priority,
                          int                signal_number)
...
int
ACE_Asynch_Accept::accept(const void        *act,
                          int                priority,
                          int                signal_number)
{
  ACE_Asynch_Accept_Result result (this->handler_,
...
int
ACE_Asynch_Connect::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_CONNECT;
}
...
int
ACE_Asynch_Connect::prepare_connect (
    ...
    if (connect_handle == ACE_INVALID_HANDLE)
    {
        ...
        if (connect_handle == ACE_INVALID_HANDLE)
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_LIB_TEXT("%N:%l:ACE_POSIX_Asynch_Connect::prepare_connect:")
        ...
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_LIB_TEXT("%N:%l:ACE_Asynch_Connect::prepare_connect:")
...
ACE_Asynch_Connect::connect(ACE_HANDLE       connect_handle,
                            ...
                            int              signal_number)
{
    int flags = 0;   // ACE_Asynch_Result::FLG_REGISTER_HANDLE;
  
    if (connect_handle == ACE_INVALID_HANDLE)
        flags |= ACE_Asynch_Result::FLG_NEW_HANDLE;
    ...
    if (rc < 0 )
    {
        if (ACE_BIT_ENABLED(flags, ACE_Asynch_Result::FLG_NEW_HANDLE))
        {
            if (connect_handle != ACE_INVALID_HANDLE)
            {
    ...
    ACE_Asynch_Connect_Result result (this->handler_,
                                      connect_handle,
                                      remote_sap,
                                      local_sap,
                                      act,
...
int
ACE_Asynch_Read_Dgram::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_READ_DGRAM;
}
...
ACE_Asynch_Read_Dgram::recv (ACE_Message_Block *message_block,
                             ...
                             int                scatter_flags)
{
  ACE_Asynch_Read_Dgram_Result result (this->handler_,
                                       this->handle_,
                                       Buffer_Info (*message_block),
                                       bytes_to_read,
                                       recv_flags,
...
int
ACE_Asynch_Read_Dgram::recv (const Buffer_Info& buf_info,
                             size_t             bytes_to_read,
                             int                recv_flags,
                             int                protocol_family,
                             const void        *act,
...
int
ACE_Asynch_Write_Dgram::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_WRITE_DGRAM;
}
...
ACE_Asynch_Write_Dgram::send (ACE_Message_Block *message_block,
                              ...
                              int                gather_flags)
{
  ACE_Asynch_Write_Dgram_Result result (this->handler_,
                                       this->handle_,
                                       addr,
                                       Buffer_Info (*message_block),
                                       bytes_to_write,
...
int
ACE_Asynch_Write_Dgram::send (const Buffer_Info& buf_info,
                              size_t             bytes_to_write,
                              int                send_flags,
                              const ACE_Addr &   addr,
                              const void        *act,
...
int
ACE_Asynch_Transmit_File::supported_operations (void) const
{
  return ACE_Asynch_Result::OP_TRANSMIT_FILE;
}
...
{
  ACE_Asynch_Transmit_File_Result result (this->handler_,
...
void
ACE_Handler::handle_user_operation(const ACE_Asynch_User_Result & /* result */)
{
}
