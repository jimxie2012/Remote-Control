...
#include "ace/POSIX_AIO_SUN_Provider.h"
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_SUN_Provider::~ACE_POSIX_AIO_SUN_Provider ()
{
    this->fini ();
}
...
int
ACE_POSIX_AIO_SUN_Provider::get_supported_operations_mask () const
{
...
// *************************************************************
int 
ACE_POSIX_AIO_SUN_Provider::register_handle (ACE_HANDLE handle,
...
int 
ACE_POSIX_AIO_SUN_Provider::unregister_handle (ACE_HANDLE handle)
{
...
int 
ACE_POSIX_AIO_SUN_Provider::init ()
{
    ...
    if (rc <= 0)
    {
        ...
        ACE_ERROR((LM_ERROR,
            ACE_TEXT("ACE_POSIX_AIO_SUN_Provider::init:")
...
int 
ACE_POSIX_AIO_SUN_Provider::fini ()
{
    this->interrupt();
...
int 
ACE_POSIX_AIO_SUN_Provider::interrupt ()
{
...
// *************************************************************
int 
ACE_POSIX_AIO_SUN_Provider::finish_aio_completions 
     (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
bool 
ACE_POSIX_AIO_SUN_Provider::begin_aio_wait 
...
// *************************************************************
int
ACE_POSIX_AIO_SUN_Provider::cancel_result
...
int
ACE_POSIX_AIO_SUN_Provider::cancel_all
    (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    Guard_Monitor guard (this->mon_provider_);
...
int
ACE_POSIX_AIO_SUN_Provider::cancel_aio
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    Guard_Monitor guard (this->mon_provider_);
...
bool
ACE_POSIX_AIO_SUN_Provider::cancel_active_queue
    (ACE_Handler * handler,
     ACE_HANDLE    handle,
     bool          flg_all,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
...
bool
ACE_POSIX_AIO_SUN_Provider::cancel_deferred_queue
    (ACE_Handler * handler,
     ACE_HANDLE    handle,
     bool          flg_all,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
...
// *****************************************************************
int 
ACE_POSIX_AIO_SUN_Provider::start_aio 
    (ACE_POSIX_Asynch_Result *result,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_UNUSED_ARG (completed_queue);
...
int 
ACE_POSIX_AIO_SUN_Provider::start_aio_impl 
    (ACE_POSIX_Asynch_Result *result)
{
    result->build_aiocb ();
...
// *****************************************************************
int 
ACE_POSIX_AIO_SUN_Provider::get_completed_aio 
    (ACE_Time_Value * wait_time,
     Guard_Monitor &  leader_guard,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{

    ACE_POSIX_Asynch_Result * posix_result = 0;
...
int
ACE_POSIX_AIO_SUN_Provider::start_deferred_queue 
    (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    int num_started = 0;
    ACE_POSIX_Asynch_Result * result;
...
ACE_POSIX_AIO_SUN_Provider::find_completed_result (aio_result_t *aio_result)
{
    ACE_POSIX_Asynch_Result_Queue tmp_queue;
    ACE_POSIX_Asynch_Result * result;
...
bool
ACE_POSIX_AIO_SUN_Provider::check_interrupter_result 
    (aio_result_t *result)
{
    ...
    if (result == &aiocb_ptr->aio_resultp)
    {
        ...
        if (rc <= 0)
        {
            int error = ACE_OS::last_error(); 
            ACE_ERROR((LM_ERROR,
                ACE_TEXT("ACE_POSIX_AIO_SUN_Provider::check_interrupter_result:")
                ACE_TEXT(" unable to start aio error=%d"),
                error));
