 ...
 *****************************************************************
 */
ACE_POSIX_AIO_Select_Provider::~ACE_POSIX_AIO_Select_Provider()
{
    fini ();
}
...
int 
ACE_POSIX_AIO_Select_Provider::get_specific_flags () const
{
    // return 0;
...
int 
ACE_POSIX_AIO_Select_Provider::init ()
{
...
int 
ACE_POSIX_AIO_Select_Provider::fini ()
{
    return 0;
}

int
ACE_POSIX_AIO_Select_Provider::interrupt ()
{
...
int
ACE_POSIX_AIO_Select_Provider::declare_interest (ACE_POSIX_AIO_FD_Info * info,
                                                 int interest,
                                                 int remain_mask)
{
...
int
ACE_POSIX_AIO_Select_Provider::clear_interest (ACE_POSIX_AIO_FD_Info * info)
{
    ACE_HANDLE fd = info->get_handle();
...
// *****************************************************************
bool
ACE_POSIX_AIO_Select_Provider::declare_interest_i (ACE_HANDLE handle,
                                                   int interest)
{
...
int
ACE_POSIX_AIO_Select_Provider::clear_interest_i (ACE_HANDLE handle,
                                               int interest)
{
    int remain_mask = 0;
    ...
    if (this->request_set_.wr_mask_.is_set (handle) != 0)
    {
        ...
        {
            remain_mask |= ACE_POSIX_AIO_FD_Info::WRITE;
        }
    }
    return remain_mask;
}
...
int
ACE_POSIX_AIO_Select_Provider::poll_ready_fd (Guard_Monitor &  leader_guard,
                                           int & ready_mask,
                                           int & remain_mask)
{
...
int
ACE_POSIX_AIO_Select_Provider::get_ready_fd (ACE_Time_Value * wait_time,
...
ACE_HANDLE
ACE_POSIX_AIO_Select_Provider::find_next_ready_fd (int & ready_mask,
                                                   int & remain_mask)
{
...
int
ACE_POSIX_AIO_Select_Provider::wait_for_ready_fd (ACE_Time_Value * wait_time)
{
    ACE_TRACE ("ACE_POSIX_AIO_Select_Provider::wait_for_ready_fd");
