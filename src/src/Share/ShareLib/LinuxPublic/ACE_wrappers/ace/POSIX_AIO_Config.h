...
#ifndef ACE_POSIX_AIO_CONFIG_H 
#define ACE_POSIX_AIO_CONFIG_H 
...
class ACE_Export ACE_POSIX_AIO_Config 
{
...
public:
    ...
    ACE_POSIX_AIO_Config (size_t  max_num_aio       = ACE_AIO_NO_LIMIT,
                          int     processor_type    = PCT_SHARED,
                          int     provider_type     = PVT_SELECT,
                          int     processor_op_mask = 0xFFFFFFFF);

    ~ACE_POSIX_AIO_Config (void);

 
    ACE_POSIX_AIO_Processor * create_processor 
           (ACE_POSIX_AIO_Dispatcher & dispatcher) const;

    ACE_POSIX_AIO_Provider * create_provider (void) const;
...
inline size_t
ACE_POSIX_AIO_Config::max_num_aio (void) const 
{ 
  return this->max_num_aio_;
}

inline int
ACE_POSIX_AIO_Config::processor_type (void) const 
{ 
    return this->processor_type_;
} 

inline int
ACE_POSIX_AIO_Config::processor_op_mask (void) const 
{
    return this->processor_op_mask_;
}

inline int
ACE_POSIX_AIO_Config::provider_type (void) const 
{
    return this->provider_type_;
}

inline int
ACE_POSIX_AIO_Config::provider_class (void) const 
{
    return (this->provider_type_ & PVC_MASK);
}

inline int
ACE_POSIX_AIO_Config::provider_flags (void) const 
{
