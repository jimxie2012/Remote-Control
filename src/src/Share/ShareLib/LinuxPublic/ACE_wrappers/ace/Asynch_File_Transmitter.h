...
//=============================================================================
/**
 *  @file    ACE_Asynch_File_Transmitter.h
 *
 *  $Id:  $
 *
...
#ifndef ACE_ASYNCH_FILE_TRANSMITTER_H 
#define ACE_ASYNCH_FILE_TRANSMITTER_H 
...
public:
  ...
  {
  public:
     virtual void on_complete (ACE_Asynch_File_Transmitter& transmitter) = 0;
     virtual ~Callback () {}
  };
  ...
  /// to write).
  ACE_Asynch_File_Transmitter (Callback & cb,
       const ACE_Asynch_Transmit_File_Result& original);

  /// Destructor.
  virtual ~ACE_Asynch_File_Transmitter (void);
  ...
  ACE_Asynch_Transmit_File_Result & get_original_result ();
...
inline void
ACE_Asynch_File_Transmitter::set_completion(u_long error)
{
...
#include "ace/post.h"
#endif // ACE_ASYNCH_FILE_TRANSMITTER_H 
