...
// ***********************************************************************
bool
ACE_Sock_Addr::is_addresses_compatible (int type1, int type2)
{
    if (type1 == type2)
    {
        return true;
...
int
ACE_Sock_Addr::copy_addr (ACE_Addr& dst, const ACE_Addr& src)
{
...
int
ACE_Sock_Addr::copy_addr (ACE_Addr & dst, const sockaddr *src, int size)
{
...
//  ACE_Sock_Addr
// ***********************************************************************
ACE_Sock_Addr::~ACE_Sock_Addr ()
{
    this->delete_i ();
}

ACE_Sock_Addr::ACE_Sock_Addr (const ACE_Sock_Addr & other)
: ace_addr_ (0)
{
    this->set_i (other.get_ace_addr ());
}

ACE_Sock_Addr::ACE_Sock_Addr (const ACE_Addr& other)
: ace_addr_ (0)
{
    this->set_i (other);
}

ACE_Sock_Addr::ACE_Sock_Addr (sockaddr *addr, int size)
: ace_addr_ (0)
{
    this->set_i (addr, size);
}

ACE_Sock_Addr::ACE_Sock_Addr (int type)
: ace_addr_ (0)
{
...
ACE_Sock_Addr& 
ACE_Sock_Addr::operator = (const ACE_Sock_Addr & other)
{
    this->set (other);
    return *this;
}
...
ACE_Sock_Addr&
ACE_Sock_Addr::operator = (const ACE_Addr & other)
{
    this->set (other);
    return *this;
}
...
int
ACE_Sock_Addr::to_string (const ACE_Addr& addr,
                          char           *buf, 
                          size_t          len, 
                          int             ip_format)
{
...
int 
ACE_Sock_Addr::to_string (char *buf, size_t len, int ip_format) const 
{
    return ACE_Sock_Addr::to_string (get_ace_addr(), buf, len, ip_format);
}

void  *
ACE_Sock_Addr::get_addr () const
{
    return get_ace_addr ().get_addr ();
}

int
ACE_Sock_Addr::get_type () const
{
...
const ACE_Addr& 
ACE_Sock_Addr::get_ace_addr ()const
{
    ACE_ASSERT (this->ace_addr_ != 0);
    return *this->ace_addr_;
}
...
int 
ACE_Sock_Addr::getsockname (ACE_HANDLE h)
{
    union
    {
        sockaddr       addr_;
    ...
    ACE_ERROR ((LM_ERROR,
        ACE_TEXT ("(%t) ACE_Sock_Addr::getsockname %p\n"),
        ACE_TEXT ("failed")));
    return -1;
}

int 
ACE_Sock_Addr::getpeername (ACE_HANDLE h)
{
    union
    {
        sockaddr       addr_;
    ...
    ACE_ERROR ((LM_ERROR,
        ACE_TEXT ("(%t) ACE_Sock_Addr::getpeername %p\n"),
        ACE_TEXT ("failed")));
    return -1;
}
...
void
ACE_Sock_Addr::set (const ACE_Sock_Addr & other)
{
    if (&other == this)
    {
        return;
...
void
ACE_Sock_Addr::set (const ACE_Addr& other)
{
...
void
ACE_Sock_Addr::set (sockaddr *addr, int size)
{
    this->delete_i ();
    this->set_i (addr, size);
}
...
void
ACE_Sock_Addr::set_type (int type)
{
...
void
ACE_Sock_Addr::set_i (const ACE_Addr & other)
{
...
void
ACE_Sock_Addr::set_i (sockaddr *addr, int size)
{
...
void
ACE_Sock_Addr::set_type_i (int type)
{
    switch (type)
    {
    case AF_INET:
