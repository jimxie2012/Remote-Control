...
#include "ace/POSIX_AIO_Select_Provider.h"
#include "ace/POSIX_AIO_Poll_Provider.h"
#include "ace/POSIX_AIO_Event_Poll_Provider.h"
#include "ace/POSIX_AIO_Dev_Poll_Provider.h"
#include "ace/POSIX_AIO_SUN_Port_Provider.h"
...
ACE_POSIX_AIO_Config::ACE_POSIX_AIO_Config(size_t  max_num_aio,    
                                           int     processor_type, 
                                           int     provider_type,
...
ACE_POSIX_AIO_Config::~ACE_POSIX_AIO_Config (void)
{
}

void
ACE_POSIX_AIO_Config::dump (void) const
{
...
size_t
ACE_POSIX_AIO_Config::max_handles (void) const 
{ 
...
ACE_POSIX_AIO_Config::create_processor 
    (ACE_POSIX_AIO_Dispatcher & dispatcher) const
{
    ACE_POSIX_AIO_Processor * processor = 0;
    ...
    case PCT_DEDICATED: 
        ACE_NEW_RETURN 
            (processor,
            ACE_POSIX_AIO_Dedicated_Processor (dispatcher,
                                               *this),
            0);
        break;
    ...
    case PCT_SHARED: 
        ACE_NEW_RETURN 
            (processor,
            ACE_POSIX_AIO_Processor (dispatcher,
                                     *this),
            0);
    default:            
        break;
...
ACE_POSIX_AIO_Provider *
ACE_POSIX_AIO_Config::create_provider (void) const
{
    ACE_POSIX_AIO_Provider * provider = 0;
    switch (this->provider_type())
    {
#if defined (ACE_HAS_AIO_CALLS) 

    case ACE_POSIX_AIO_Config::PVT_POSIX_AIOCB:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_AIOCB_Provider (*this),
                        0);
        break;

    case ACE_POSIX_AIO_Config::PVT_POSIX_CB:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_CB_Provider (*this),
                        0);
        break;

#if defined(sun)
    case ACE_POSIX_AIO_Config::PVT_SUN_AIO:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_SUN_Provider (*this),
                        0);
        break;
#endif // (sun)        

#if defined(linux) && defined(ACE_HAS_LINUX_LIBAIO) 
    case ACE_POSIX_AIO_Config::PVT_LINUX_NAIO:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_LINUX_NAIO_Provider (*this),
                        0);
        break;
#endif // (linux)
    ...
    case ACE_POSIX_AIO_Config::PVT_SELECT:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_Select_Provider (*this),
                        0);
        break;

    case ACE_POSIX_AIO_Config::PVT_POLL:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_Poll_Provider (*this),
                        0);
        break;

#if defined(linux) && defined(ACE_HAS_LINUX_EPOLL) 
    case ACE_POSIX_AIO_Config::PVT_EPOLL:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_Event_Poll_Provider (*this),
                        0);
        break;
#endif

#if defined(sun) && defined(ACE_HAS_DEV_POLL)
    case ACE_POSIX_AIO_Config::PVT_DEVPOLL:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_Dev_Poll_Provider (*this),
                        0);
        break;
#endif

#if defined(sun) && defined(ACE_HAS_SUN_COMPLETION_PORTS)
    case ACE_POSIX_AIO_Config::PVT_SUNPORT:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_SUN_Port_Provider (*this),
                        0);
        break;
#endif
...
//#if (defined(__FreeBSD__) || defined(__APPLE__)) && defined(ACE_HAS_KQUEUE)
    ...
    case ACE_POSIX_AIO_Config::PVT_KQUEUE:
        ACE_NEW_RETURN (provider,
                        ACE_POSIX_AIO_Kqueue_Provider (*this),
                        0);
        break;
#endif
