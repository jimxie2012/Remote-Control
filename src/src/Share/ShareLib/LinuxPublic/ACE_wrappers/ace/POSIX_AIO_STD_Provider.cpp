...
#include "ace/POSIX_AIO_STD_Provider.h"
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_STD_Provider::~ACE_POSIX_AIO_STD_Provider ()
{
}

ACE_POSIX_AIO_STD_Provider::ACE_POSIX_AIO_STD_Provider
    (const ACE_POSIX_AIO_Config & config)
: ACE_POSIX_AIO_Provider (config)
, mon_provider_    ()
, started_queue_   ()
, wait_queue_      ()
, deferred_queue_  ()
...
int
ACE_POSIX_AIO_STD_Provider::get_supported_operations_mask () const
{
...
// *************************************************************
int
ACE_POSIX_AIO_STD_Provider::register_handle (ACE_HANDLE handle,
...
int
ACE_POSIX_AIO_STD_Provider::unregister_handle (ACE_HANDLE handle)
{
...
// *************************************************************
int
ACE_POSIX_AIO_STD_Provider::finish_aio_completions
...
bool
ACE_POSIX_AIO_STD_Provider::begin_aio_wait
...
int
ACE_POSIX_AIO_STD_Provider::start_deferred_queue
    (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    int num_started = 0;
...
int
ACE_POSIX_AIO_STD_Provider::check_wait_queue
    (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_POSIX_Asynch_Result * result;
    int num_completed = 0;
...
int
ACE_POSIX_AIO_STD_Provider::cancel_all
    (ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    {
...
int
ACE_POSIX_AIO_STD_Provider::cancel_aio
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    {
...
bool
ACE_POSIX_AIO_STD_Provider::cancel_active_queue
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & active_queue,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_UNUSED_ARG (completed_queue);
    ACE_POSIX_Asynch_Result_Queue::iterator it1 = active_queue.begin();
    ACE_POSIX_Asynch_Result_Queue::iterator it2 = active_queue.end();

    for (; it1 != it2 ; ++it1)
    {
        ACE_POSIX_Asynch_Result * result = (*it1);
        if (handler == 0 ||
...
bool
ACE_POSIX_AIO_STD_Provider::cancel_deferred_queue
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
int
ACE_POSIX_AIO_STD_Provider::start_aio_impl
    (ACE_POSIX_Asynch_Result *result)
{
    result->build_aiocb ();
    struct aiocb * aiocb_ptr = result->get_aiocb (); 
    ...
    {
    case ACE_Asynch_Result::OP_READ_STREAM:
    case ACE_Asynch_Result::OP_READ_FILE:
        rc = ::aio_read(aiocb_ptr);
        break;

    case ACE_Asynch_Result::OP_WRITE_STREAM:
    case ACE_Asynch_Result::OP_WRITE_FILE:
        rc = ::aio_write (aiocb_ptr);
        break;

    case ACE_Asynch_Result::OP_READ_DGRAM:
    case ACE_Asynch_Result::OP_ACCEPT:
    case ACE_Asynch_Result::OP_WRITE_DGRAM:
    case ACE_Asynch_Result::OP_CONNECT:
...
bool
ACE_POSIX_AIO_STD_Provider::test_result_status (ACE_POSIX_Asynch_Result *result)
{
    struct aiocb * aiocb_ptr = result->get_aiocb (); 
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_AIOCB_Provider::~ACE_POSIX_AIO_AIOCB_Provider ()
{
    fini ();
}
...
ACE_POSIX_AIO_AIOCB_Provider::ACE_POSIX_AIO_AIOCB_Provider
    (const ACE_POSIX_AIO_Config & config)
: ACE_POSIX_AIO_STD_Provider (config)
...
int
ACE_POSIX_AIO_AIOCB_Provider::init ()
{
    Guard_Monitor guard (this->mon_provider_);
...
int
ACE_POSIX_AIO_AIOCB_Provider::fini ()
{
    this->interrupt();
    ACE_POSIX_Asynch_Result_Queue completed_queue;
...
int
ACE_POSIX_AIO_AIOCB_Provider::interrupt ()
{
...
int
ACE_POSIX_AIO_AIOCB_Provider::start_aio
    (ACE_POSIX_Asynch_Result *result,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_UNUSED_ARG (completed_queue);
...
// *****************************************************************
int
ACE_POSIX_AIO_AIOCB_Provider::get_completed_aio
    (ACE_Time_Value * wait_time,
     Guard_Monitor &  leader_guard,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
bool
ACE_POSIX_AIO_AIOCB_Provider::check_interrupter_result ()
{
    ...
    if (rc <= 0)
    {
        ...
        ACE_ERROR((LM_ERROR,
            ACE_TEXT("ACE_POSIX_AIO_AIOCB_Provider::check_interrupter_result:")
...
bool
ACE_POSIX_AIO_AIOCB_Provider::wait_for_aio (ACE_Time_Value * wait_time,
                                          int count)
{
    int rc = 0;
    ...
    if (rc == -1)
    {
        ...
        default:
            ACE_ERROR((LM_ERROR,
                ...
                ACE_LIB_TEXT ("ACE_POSIX_AIO_AIOCB_Provider::wait")
...
int
ACE_POSIX_AIO_AIOCB_Provider::build_wait_queue ()
{
    int i=0;
 ...
 *****************************************************************
 */
void ACE_POSIX_AIO_CB_Provider::aio_completion_func (sigval_t cb_data)
{
  ACE_POSIX_AIO_CB_Provider * impl =
      static_cast<ACE_POSIX_AIO_CB_Provider *> (cb_data.sival_ptr);
  if ( impl != 0 )
      impl->interrupt();
}
...
extern "C" void
ACE_POSIX_AIO_CB_Provider_aio_completion (sigval_t cb_data)
{
    ACE_POSIX_AIO_CB_Provider::aio_completion_func (cb_data);
}
#endif /* ACE_HAS_SIG_C_FUNC */

ACE_POSIX_AIO_CB_Provider::~ACE_POSIX_AIO_CB_Provider ()
{
    fini ();
}
...
int
ACE_POSIX_AIO_CB_Provider::init ()
{
    return 0;
}

int
ACE_POSIX_AIO_CB_Provider::fini ()
{
    this->interrupt();
    ACE_POSIX_Asynch_Result_Queue completed_queue;
    this->cancel_all (completed_queue);
...
int
ACE_POSIX_AIO_CB_Provider::interrupt ()
{
...
int
ACE_POSIX_AIO_CB_Provider::start_aio
    (ACE_POSIX_Asynch_Result *result,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
  ACE_UNUSED_ARG (completed_queue);
...
#  if defined (ACE_HAS_SIG_C_FUNC)
    aiocb_ptr->aio_sigevent.sigev_notify_function =
        ACE_POSIX_AIO_CB_Provider_aio_completion;
#  else
...
// *****************************************************************
int
ACE_POSIX_AIO_CB_Provider::get_completed_aio
    (ACE_Time_Value * wait_time,
     Guard_Monitor &  leader_guard,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
bool
ACE_POSIX_AIO_CB_Provider::wait_for_aio (ACE_Time_Value * wait_time)
{
    int rc = 0;
    if (wait_time == 0) //  wait indefinetely
    {
    ...
    if (rc == -1)
    {
        ...
        default:
            ACE_ERROR((LM_ERROR,
                ACE_LIB_TEXT ("%N:%l:(%P | %t)::%p\n"),
                ACE_LIB_TEXT ("ACE_POSIX_AIO_CB_Provider::wait")
