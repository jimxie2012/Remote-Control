...
#ifndef ACE_ASYNCH_ACCEPTOR2_C 
#define ACE_ASYNCH_ACCEPTOR2_C 

#include "ace/Asynch_Acceptor2.h"
...
ACE_Asynch_Acceptor2<HANDLER>::ACE_Asynch_Acceptor2 (void)
: default_addr_  ()
, listen_addr_   ()
, monitor_       ()
, flg_cancel_    (false)
...
ACE_Asynch_Acceptor2<HANDLER>::open (const ADDRESS& address,
...
{
    ACE_TRACE ("ACE_Asynch_Acceptor2<>::open");
...
template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::get_pending_count (void) const
{
    Guard_Monitor guard (monitor_);
...
ACE_Asynch_Acceptor2<HANDLER>::get_handle (void) const
{
    return this->listen_handle_;
}

template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::accept (size_t bytes_to_read, const void *act)
{
    Guard_Monitor guard (monitor_);
...
template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::accept_i (size_t bytes_to_read, 
                                         const void *act,
                                         Guard_Monitor& guard)
{
    ACE_TRACE ("ACE_Asynch_Acceptor2<>::accept_i");
...
template <class HANDLER>
const typename ACE_Asynch_Acceptor2<HANDLER>::ADDRESS&
ACE_Asynch_Acceptor2<HANDLER>::get_completion_address (
    ...
    const ACE_Addr& addr)
{
    ...
    if (def_type == AF_ANY ||
        ACE_Sock_Addr::is_addresses_compatible (def_type,
                                                comp_type))
    {
...
ACE_Asynch_Acceptor2<HANDLER>::handle_accept (const ACE_Asynch_Accept::Result &result)
{
    ACE_TRACE ("ACE_Asynch_Acceptor2<>::handle_accept");
...
template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::validate_connection
...
template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::wait (void)
{
    Guard_Monitor guard (monitor_);
...
template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::cancel (void)
{
    ACE_TRACE ("ACE_Asynch_Acceptor2<>::cancel");
...
template <class HANDLER> ACE_HANDLE
ACE_Asynch_Acceptor2<HANDLER>::handle (void) const
{
    return this->listen_handle_;
}

template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::handle (ACE_HANDLE /*h*/)
{
...
ACE_Asynch_Acceptor2<HANDLER>::make_handler (const void * /*act*/)
{
    return make_handler();
}

template <class HANDLER> HANDLER *
ACE_Asynch_Acceptor2<HANDLER>::make_handler (void)
{
    // Default behavior
    HANDLER *handler = 0;
...
template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::pass_addresses (void) const
{
    return this->pass_addresses_;
}

template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::pass_addresses (int new_value)
{
    this->pass_addresses_ = new_value;
}

template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::validate_new_connection (void) const
{
    return this->validate_new_connection_;
}

template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::validate_new_connection (int new_value)
{
    this->validate_new_connection_ = new_value;
}

template <class HANDLER> int
ACE_Asynch_Acceptor2<HANDLER>::reissue_accept (void) const
{
    return this->reissue_accept_;
}

template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::reissue_accept (int new_value)
{
    this->reissue_accept_ = new_value;
}

template <class HANDLER> size_t
ACE_Asynch_Acceptor2<HANDLER>::bytes_to_read (void) const
{
    return this->bytes_to_read_;
}

template <class HANDLER> void
ACE_Asynch_Acceptor2<HANDLER>::bytes_to_read (size_t new_value)
{
