...
//#define ACE_UNLOCK_MUTEX_FOR_IO
...
#ifdef ACE_UNLOCK_MUTEX_FOR_IO
#undef ACE_UNLOCK_MUTEX_FOR_IO
#endif
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_FD_Repository::ACE_POSIX_AIO_FD_Repository
...
void
ACE_POSIX_AIO_FD_Repository::close ()
{
...
int
ACE_POSIX_AIO_FD_Repository::open(size_t num_files, size_t num_slots)
{
    //this->close ();
    ...
    ACE_NEW_RETURN (this->array_info_,
                    ACE_POSIX_AIO_FD_Info *[num_files_],
                   -1);
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_FD_Repository::FD_Guard::FD_Guard(ACE_POSIX_AIO_FD_Repository & rep,
                                                ACE_HANDLE handle,
                                                bool flgCreate)
...
, fd_info_      (0)
{
    ...
    if (flgCreate)
    {
        ACE_NEW_NORETURN (this->fd_info_, ACE_POSIX_AIO_FD_Info (handle));
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_FD_Info::ACE_POSIX_AIO_FD_Info (int fd)
: fd_            (fd)
, link_interest_ ()
, link_execute_  ()
, read_op_list_  ()
...
ACE_POSIX_AIO_FD_Info::~ACE_POSIX_AIO_FD_Info (void)
{
}

int
ACE_POSIX_AIO_FD_Info::open(int mask,
                            FD_Guard &  guard)
{
...
int
ACE_POSIX_AIO_FD_Info::start_read (ACE_POSIX_Asynch_Result * result,
                                   FD_Guard &  guard,
...
int
ACE_POSIX_AIO_FD_Info::start_write (ACE_POSIX_Asynch_Result * result,
                                   FD_Guard &  guard,
                                   ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    FD_Guard::Save_Guard saver(guard, FD_Guard::Save_Guard::ACQUIRE);
...
int
ACE_POSIX_AIO_FD_Info::cancel_handler(FD_Guard &  guard,
                                ACE_Handler * handler,
                                ACE_POSIX_Asynch_Result_Queue & canceled_queue)
{
    ...
    ACE_POSIX_Asynch_Result_List::iterator it1 = read_op_list_.begin();
    ACE_POSIX_Asynch_Result_List::iterator it2 = read_op_list_.end();
...
int
ACE_POSIX_AIO_FD_Info::cancel(FD_Guard &  guard,
                              ACE_POSIX_Asynch_Result_Queue & canceled_queue)
{
    FD_Guard::Save_Guard saver(guard, FD_Guard::Save_Guard::ACQUIRE);
...
int
ACE_POSIX_AIO_FD_Info::cancel_list (ACE_POSIX_Asynch_Result_List & pending_list,
                                    ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_POSIX_Asynch_Result_List::iterator it1 = pending_list.begin();
    ACE_POSIX_Asynch_Result_List::iterator it2 = pending_list.end();
...
int
ACE_POSIX_AIO_FD_Info::execute (FD_Guard &  guard,
                                ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    FD_Guard::Save_Guard saver(guard,  FD_Guard::Save_Guard::ACQUIRE);
...
bool
ACE_POSIX_AIO_FD_Info::execute_list (FD_Guard&  guard,
