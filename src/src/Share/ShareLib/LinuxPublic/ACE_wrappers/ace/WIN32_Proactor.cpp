...

{
  ...
  if (this->completion_port_ == 0)
    ACE_ERROR ((LM_ERROR,
                ACE_LIB_TEXT ("ACE_WIN32_Proactor %p\n"),
      ...
      for (;;)
        {
          ...
          // Narrow the result.
          ACE_WIN32_Asynch_Result * win32_result = 
            static_cast<ACE_WIN32_Asynch_Result *> (overlapped);

          ACE_WIN32_Asynch_Result::release(win32_result);
        }
...
int
ACE_WIN32_Proactor::unregister_handle (ACE_HANDLE handle)
{
...
// *****************************************************************************
int 
ACE_WIN32_Proactor::get_max_result_size (void) const
{
...
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Read_Stream_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Read_Stream_Result>
                          (result,
                           &this->allocator11_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Write_Stream_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Write_Stream_Result>
                          (result,
                           &this->allocator12_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Read_Dgram_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Read_Dgram_Result>
                          (result,
                           &this->allocator2_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Write_Dgram_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Write_Dgram_Result>
                          (result,
                           &this->allocator2_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Connect_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Connect_Result>
                          (result,
                           &this->allocator2_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Accept_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Accept_Result>
                          (result,
                           &this->allocator2_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Transmit_File_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_Transmit_File_Result>
                          (result,
                           &this->allocator3_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_Timer & result)
{
   return create_win32_result<ACE_WIN32_Asynch_Timer>
                          (result,
                           &this->allocator3_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Wakeup_Completion & result)
{
  return create_win32_result<ACE_WIN32_Wakeup_Completion>
                          (result,
                           &this->allocator3_,
                           this);
}
...
ACE_Asynch_Result_Impl *
ACE_WIN32_Proactor::create_result_impl (const ACE_Asynch_User_Result & result)
{
  return create_win32_result<ACE_WIN32_Asynch_User_Result>
                          (result,
                           &this->allocator3_,
                           this);
}
...
// *****************************************************************************
int
ACE_WIN32_Proactor::post (ACE_WIN32_Asynch_Result *win32_result)
{
  if (win32_result == 0)
    return -1;

  ACE_Asynch_Result & user_result = win32_result->get_original_result ();
  ...
  if (::PostQueuedCompletionStatus (this->completion_port_,           // completion port
                                ...
                                ) == FALSE)
    {
      ...
      //!!!! ACE_Asynch_Result_Impl will call free ()!!!! 
      //ACE_WIN32_Asynch_Result::release (win32_result);
...
int
ACE_WIN32_Proactor::cancel_aio (ACE_HANDLE h)
{
...
int
ACE_WIN32_Proactor::cancel_aio (ACE_Handler * handler)
{
  //return this->cancel_aio (handler->handle());
  std::set<ACE_WIN32_Asynch_Connect_Result*>::iterator it1 =
      this->pending_connects_.begin ();

  std::set<ACE_WIN32_Asynch_Connect_Result*>::iterator it2 =
      this->pending_connects_.end ();

  for (; it1 != it2; ++ it1)
    {
      ACE_WIN32_Asynch_Connect_Result *result = (*it1);
      ACE_Asynch_Result & original = result->get_original_result ();

      if (original.get_handler () == handler &&
          ACE_BIT_ENABLED(original.op_flags(), ACE_Asynch_Result::FLG_NEW_HANDLE))
        {
...
int
ACE_WIN32_Proactor::cancel_all_aio (void)
{
  // Couldnt cancel the operations.
  return 2;
}
...
void
ACE_WIN32_Proactor::add_connect(ACE_WIN32_Asynch_Connect_Result *result)
{
...
void
ACE_WIN32_Proactor::remove_connect(ACE_WIN32_Asynch_Connect_Result *result)
{
    ACE_GUARD (ACE_SYNCH_MUTEX, guard, this->pending_connects_mutex_);
