...
#ifndef ACE_POSIX_AIO_LINUX_NAIO_PROVIDER_H 
#define ACE_POSIX_AIO_LINUX_NAIO_PROVIDER_H 
...
class ACE_Export ACE_POSIX_AIO_LINUX_NAIO_Provider 
    : public ACE_POSIX_AIO_Provider 
{
   ...
   /**
     ...
     *
     */
    class ACE_Export Notification_File
    {
    public:
        Notification_File ();
...
public:
    ...
    ACE_POSIX_AIO_LINUX_NAIO_Provider (const ACE_POSIX_AIO_Config & config);
    virtual ~ACE_POSIX_AIO_LINUX_NAIO_Provider();
...
private:
    ...
    int cancel_queue (ACE_Handler * handler,
...
inline int
ACE_POSIX_AIO_LINUX_NAIO_Provider::max_files () const
{
...
#endif //ACE_POSIX_AIO_LINUX_NAIO_PROVIDER_H 
