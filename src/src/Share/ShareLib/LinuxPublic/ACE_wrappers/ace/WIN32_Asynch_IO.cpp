...
ACE_WIN32_Asynch_Result::ACE_WIN32_Asynch_Result (
                             ...
                             DWORD               offset_high)
: OVERLAPPED  ()
, ACE_Asynch_Result_Impl (allocator , area)
...
int
ACE_WIN32_Asynch_Result::check_start_error (bool  rc_start,
                                            const ACE_TCHAR *op_name)
{
    ...
    ACE_Asynch_Result & user_result = this->get_original_result ();
    user_result.set_completion (0, ::GetLastError ());

    if (ACE_BIT_ENABLED(user_result.op_flags (), ACE_Asynch_Result::FLG_NEW_HANDLE))
    {
...
int
ACE_WIN32_Asynch_Result::complete (size_t              bytes_transferred,
                                   ...
                                   u_long              error)
{
    ...
    if (ACE_BIT_ENABLED (user_result.op_flags(), 
                         ACE_Asynch_Result::FLG_FAKE_RESULT))
    {
        return 0;
    }
...
int
ACE_WIN32_Asynch_Result::on_complete ()
{
    return 0;
}

int
ACE_WIN32_Asynch_Result::post_impl ()
{
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Read_Stream_Result::get_original_result () 
{
   return this->original_;
}

int
ACE_WIN32_Asynch_Read_Stream_Result::start_impl ()
{
    if (!this->original_.is_iov_operation ())
        return this->start_read_generic ();

    // iovec operation
    if (this->original_.op_code() == ACE_Asynch_Result::OP_READ_FILE)
...
int
ACE_WIN32_Asynch_Read_Stream_Result::start_read_generic ()
{
...
int
ACE_WIN32_Asynch_Read_Stream_Result::start_readv_stream ()
{
    size_t    bytes_to_read = original_.bytes_requested ();
    DWORD        bytes_read = original_.bytes_transferred ();
...
int
ACE_WIN32_Asynch_Read_Stream_Result::start_readv_file ()
{
    size_t    bytes_to_read  = original_.bytes_requested ();
    DWORD        bytes_read  = 0;
             ...
             ++i, ++buffer_pointers_count )
        {
            if (iov[i].iov_len != page_size)
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_LIB_TEXT ("ACE_WIN32_Asynch_Read_Stream_Result::start_readv_file:")
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Write_Stream_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_WIN32_Asynch_Write_Stream_Result::start_impl ()
{ 
    if (!this->original_.is_iov_operation ())
        return this->start_write_generic ();

    // iovec operation
    if (this->original_.op_code() == ACE_Asynch_Result::OP_WRITE_FILE)
...
int
ACE_WIN32_Asynch_Write_Stream_Result::start_write_generic ()
{
...
int
ACE_WIN32_Asynch_Write_Stream_Result::start_writev_stream ()
{
    size_t    bytes_to_write = original_.bytes_requested ();
    DWORD     bytes_written  = original_.bytes_transferred ();
...
int
ACE_WIN32_Asynch_Write_Stream_Result::start_writev_file ()
{
    size_t    bytes_to_write  = original_.bytes_requested ();
    ...
    if (this->original_.is_direct_buffers ())
    {
             ...
             ++i, ++buffer_pointers_count )
        {
            ...
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_LIB_TEXT ("ACE_WIN32_Asynch_Read_Stream_Result::start_writev_file:")
                    ACE_LIB_TEXT ("Invalid iov_len size\n")),
                    -1);
            }
    ...
    else
    {
             ...
             msg = msg->cont (), ++buffer_pointers_count )
        {
            ...
            {
                ACE_ERROR_RETURN ((LM_ERROR,
                    ACE_LIB_TEXT ("ACE_WIN32_Asynch_Write_Stream_Result::start_writev_file")
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Read_Dgram_Result::get_original_result () 
{
    return this->original_;
}

int
ACE_WIN32_Asynch_Read_Dgram_Result::start_impl ()
{ 
...
int
ACE_WIN32_Asynch_Read_Dgram_Result::on_complete ()
{
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Write_Dgram_Result::get_original_result () 
{
    return this->original_;
}

int
ACE_WIN32_Asynch_Write_Dgram_Result::start_impl ()
{ 
    // to be compatible with original ACE version
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Connect_Result::get_original_result () 
{
    return this->original_;
}

int
ACE_WIN32_Asynch_Connect_Result::start_impl ()
{ 
    DWORD       bytes_written = 0;
...
int
ACE_WIN32_Asynch_Connect_Result::on_complete ()
{
    this->win32_proactor ()->remove_connect (this);
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Accept_Result::get_original_result () 
{
   return this->original_;
}

int
ACE_WIN32_Asynch_Accept_Result::start_impl ()
{ 
    ...
    else
    {
        ...
        if (space <  2*address_size)
        {
            errno = ENOSPC;
            ACE_ERROR_RETURN ((LM_ERROR, 
                ACE_LIB_TEXT ("ACE_WIN32_Asynch_Accept_Result::start:")
    ...
    if (original_.accept_handle () == ACE_INVALID_HANDLE)
    {
        ...
        if (accept_handle == ACE_INVALID_HANDLE)
        {
            ...
            {
                ACE_DEBUG ((LM_ERROR,
                    ACE_LIB_TEXT ("ACE_WIN32_Asynch_Accept_Result::start:%p\n"),
...
int
ACE_WIN32_Asynch_Accept_Result::on_complete ()
{
    if (original_.error () == 0) 
    {
        DWORD    bytes_to_read = original_.bytes_requested ();
...
ACE_Asynch_Result &
ACE_WIN32_Asynch_Transmit_File_Result::get_original_result () 
{
  return this->original_;
}

int
ACE_WIN32_Asynch_Transmit_File_Result::start_impl ()
{ 
    size_t    bytes_to_write = original_.bytes_requested ();
