...
#include "ace/POSIX_AIO_LINUX_NAIO_Provider.h"
...
/**
 *****************************************************************
 *  ACE_POSIX_AIO_Provider::Notification_File
 *****************************************************************
 */
ACE_POSIX_AIO_LINUX_NAIO_Provider::Notification_File::Notification_File ()
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::Notification_File::close ()
{
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::Notification_File::open ()
{
    if (this->handle_ != ACE_INVALID_HANDLE)
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::Notification_File::notify (io_context_t context)
{
...
bool 
ACE_POSIX_AIO_LINUX_NAIO_Provider::Notification_File::check(struct io_event& event)
{
 ...
 *****************************************************************
 */
ACE_POSIX_AIO_LINUX_NAIO_Provider::~ACE_POSIX_AIO_LINUX_NAIO_Provider ()
{
    this->fini ();
}
...
// *************************************************************
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::init ()
{
    if (this->context_ != 0)
    ...
    if (this->register_handle(interrupter_.handle (), 
                              0,
                              ACE_Asynch_Result::OP_WRITE_FILE) != 0)
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::fini ()
{
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::interrupt ()
{
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::get_supported_operations_mask () const
{
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::register_handle (ACE_HANDLE handle,
                                         ...
                                         int operations)
{
    ...
    ACE_POSIX_AIO_FD_Info * info = fd_guard.get_fd_info ();
    if (info == 0)
    {
        return -1;
    }

    int rc = info->open (ACE_POSIX_AIO_FD_Info::OPEN_READ | 
                         ACE_POSIX_AIO_FD_Info::OPEN_WRITE, 
                         fd_guard);
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::unregister_handle (ACE_HANDLE handle)
{
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::cancel_all
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::cancel_aio
    (ACE_Handler * handler,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    size_t num_files = this->repository_.size ();
    ...
    for ( size_t i = 0 ; i <  num_files; ++i)
    {
        ...
        ACE_POSIX_AIO_FD_Info * info = guard.get_fd_info ();
        if (info == 0)
        {
            continue;
        }
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::cancel_queue(
                            ACE_Handler * handler,
                            ACE_POSIX_Asynch_Result_List & pending_list,
                            ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_POSIX_Asynch_Result_List  tmp_list;
    struct io_event event;

    for (;;)
    {
        ACE_POSIX_Asynch_Result * result = pending_list.pop_front ();
        if (result == 0)
            break;
...
int 
ACE_POSIX_AIO_LINUX_NAIO_Provider::start_aio 
    (ACE_POSIX_Asynch_Result *result,
     ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ...
    ACE_POSIX_Asynch_Result_List *list = 0;

    ACE_POSIX_AIO_FD_Info * info;
    ...
    //
    //if (op_code == ACE_Asynch_Result::OP_CONNECT)
    //{
    //    ACE_POSIX_Asynch_Connect_Result * connect_result =  
    //        static_cast<ACE_POSIX_Asynch_Connect_Result*> (result);
    //        
...
// *************************************************************
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::get_completed_aio 
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::find_next_event (struct io_event& event)
{ 
...
int
ACE_POSIX_AIO_LINUX_NAIO_Provider::wait_for_events (ACE_Time_Value *wait_time)
{
...
void
ACE_POSIX_AIO_LINUX_NAIO_Provider::process_event (struct io_event& event,
                          ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    ACE_POSIX_Asynch_Result * result =
        (ACE_POSIX_Asynch_Result *) event.data;
...

    {
        ...
        ACE_POSIX_Asynch_Result *ret = list->remove (result);
...
// *************************************************************
bool  
ACE_POSIX_AIO_LINUX_NAIO_Provider::begin_aio_wait 
      (ACE_Time_Value * wait_time,
       Guard_Monitor &  leader_guard,
       ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
...
// *************************************************************
int  
ACE_POSIX_AIO_LINUX_NAIO_Provider::finish_aio_completions (
                    ACE_POSIX_Asynch_Result_Queue & completed_queue)
