 ...
 *****************************************************************
 */
ACE_POSIX_AIO_SUN_Port_Provider::~ACE_POSIX_AIO_SUN_Port_Provider()
{
    fini ();
}
...
int 
ACE_POSIX_AIO_SUN_Port_Provider::get_specific_flags () const
{
    //return 0;  
...
int
ACE_POSIX_AIO_SUN_Port_Provider::init ()
{
...
int
ACE_POSIX_AIO_SUN_Port_Provider::fini ()
{
    if (this->fd_poller_ != ACE_INVALID_HANDLE)
    {
...
int
ACE_POSIX_AIO_SUN_Port_Provider::interrupt()
{
    int events = 0;
    void * user_data = 0;
...
// *****************************************************************
int
ACE_POSIX_AIO_SUN_Port_Provider::declare_interest (ACE_POSIX_AIO_FD_Info * info,
                                                   int interest,
                                                   int remain_mask)
{
    ...
    {
        ACE_ERROR ((LM_ERROR,
            ACE_LIB_TEXT("ACE_POSIX_AIO_SUN_Port_Provider::declare_interest: ")
...
int
ACE_POSIX_AIO_SUN_Port_Provider::clear_interest  (ACE_POSIX_AIO_FD_Info * info)
{
    int fd = info->get_handle ();
...
//    {
//        ACE_ERROR ((LM_ERROR,
//            ACE_LIB_TEXT("ACE_POSIX_AIO_SUN_Port_Provider::clear_interest: ")
//            ACE_LIB_TEXT("fd=%d %p\n"),
//            fd,
...
int
ACE_POSIX_AIO_SUN_Port_Provider::poll_ready_fd (Guard_Monitor &  leader_guard,
                                           int & ready_mask,
                                           int & remain_mask)
{
    //
...
int
ACE_POSIX_AIO_SUN_Port_Provider::get_ready_fd (ACE_Time_Value * wait_time,
...
//
//ACE_HANDLE
//ACE_POSIX_AIO_SUN_Port_Provider::find_next_ready_fd (
//                                           int & ready_mask,
//                                           int & remain_mask)
//{
//    ready_mask = 0;
...
//
//int
//ACE_POSIX_AIO_SUN_Port_Provider::wait_for_ready_fd (ACE_Time_Value * wait_time)
//{
//    timespec_t   timeout;
//    timespec_t * ptimeout = 0;
//
