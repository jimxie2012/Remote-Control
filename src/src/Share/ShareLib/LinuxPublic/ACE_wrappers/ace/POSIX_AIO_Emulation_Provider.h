...
#ifndef ACE_POSIX_AIO_EMULATION_PROVIDER_H 
#define ACE_POSIX_AIO_EMULATION_PROVIDER_H 
...
class ACE_Export ACE_POSIX_AIO_Emulation_Provider 
    : public ACE_POSIX_AIO_Provider 
{
public:

    ACE_POSIX_AIO_Emulation_Provider (const ACE_POSIX_AIO_Config & config);
    virtual ~ACE_POSIX_AIO_Emulation_Provider();
...
protected:
    ...
    ACE_POSIX_AIO_FD_Repository& get_repository();
    ...
    virtual int clear_interest   (ACE_POSIX_AIO_FD_Info * info) = 0;
    ...
    //
private:
    int  execute (ACE_POSIX_AIO_FD_Info * fd_info,
                  ACE_POSIX_Asynch_Result_Queue & completed_queue);



    ACE_POSIX_AIO_FD_Repository repository_;
    FD_Info_Exec_List           exec_list_;
    Monitor                     exec_monitor_;
};

inline int
ACE_POSIX_AIO_Emulation_Provider::max_files () const
{
    return this->repository_.max_files ();
}

inline ACE_POSIX_AIO_FD_Repository& 
ACE_POSIX_AIO_Emulation_Provider::get_repository()
{
...
#endif //ACE_POSIX_AIO_EMULATION_PROVIDER_H 
