...
ACE_SSL_Asynch_Stream::ACE_SSL_Asynch_Stream (
  ACE_SSL_Asynch_Stream::Stream_Type type,
    ...
    mutex_        ()
{
  ...
  if (this->ssl_ == 0)
    ACE_ERROR
      ((LM_ERROR,
        ACE_TEXT ("(%t) ACE_SSL_Asynch_Stream %p\n"),
        ...
        if (ACE_BIT_DISABLED (this->flags_, SF_DELETE_ENABLE))
          {
            ACE_ASSERT (0); 
            ACE_DEBUG ((LM_DEBUG,
                    ACE_TEXT("(%t) ACE_SSL_Asynch_Stream::DTOR-")
...
int
ACE_SSL_Asynch_Stream::supported_operations (void) const
{
...
int
ACE_SSL_Asynch_Stream::close_handle (void)
{
                             ...
                             int pass_ownership)
{
  ...
  if (handle == ACE_INVALID_HANDLE)
    ACE_ERROR_RETURN
      ((LM_ERROR,
        ACE_TEXT ("(%t) ACE_SSL_Asynch_Stream::open()")
                             ...
                             int signal_number)
{
  ...
  new (&this->ext_read_result_) 
    ACE_Asynch_Read_Stream_Result (this->handler_,
                                   this->handle_,
                                   message_block,
                                   bytes_to_read,
                                   act,
                              ...
                              int signal_number)
{
  ...
  new (&this->ext_write_result_) 
    ACE_Asynch_Write_Stream_Result (this->handler_,
                                   this->handle_,
                                   message_block,
                                   bytes_to_write,
                                   act,
...
// ************************************************************
int
ACE_SSL_Asynch_Stream::do_SSL_state_machine (int flg_cb)
{
...
// ************************************************************
int
ACE_SSL_Asynch_Stream::do_SSL_shutdown (int flg_cb)
{
...
// ************************************************************
int
ACE_SSL_Asynch_Stream::do_SSL_read (int flg_cb)
{
...
// ************************************************************
int
ACE_SSL_Asynch_Stream::do_SSL_write (int flg_cb)
{
...
ACE_SSL_Asynch_Stream::notify_close (void)
{
  ...
  ACE_Wakeup_Completion close_result (this,
                                      0,  // act
                                      this->completion_key (),
                                      0,  // priotity
                                      0); // signal_number
...
int
ACE_SSL_Asynch_Stream::notify_read (int flg_cb,
                                    ...
                                    int error)
{
  ...
  ACE_Asynch_Read_Stream_Result user_result (this->ext_read_result_);
...
int
ACE_SSL_Asynch_Stream::notify_write (int flg_cb,
                                     int bytes_transferred,
                                     int error)
{
  ...
  ACE_Asynch_Write_Stream_Result user_result (this->ext_write_result_);
  ...
  if (this->bio_inp_msg_.size (len) != 0)
    {
      ACE_ERROR
        ((LM_ERROR,
          ACE_TEXT ("(%t) %N:%l ACE_SSL_Asynch_Stream %p\n"),
...
void 
ACE_SSL_Asynch_Stream::bio_cancel ()
{
