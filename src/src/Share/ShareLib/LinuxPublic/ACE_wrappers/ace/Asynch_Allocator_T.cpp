...
#ifndef ACE_POSIX_AIO_ALLOCATOR_T_C 
#define ACE_POSIX_AIO_ALLOCATOR_T_C 
...
ACE_Asynch_Allocator_T<ACE_LOCK>::ACE_Asynch_Allocator_T (size_t chunk_size)
...
template <class ACE_LOCK>
ACE_Asynch_Allocator_T<ACE_LOCK>::~ACE_Asynch_Allocator_T (void)
{
  int i=0;
  for (;;++i)
    {
...
ACE_Asynch_Allocator_T<ACE_LOCK>::malloc (size_t nbytes)
{
...
template <class ACE_LOCK> ACE_INLINE void *
ACE_Asynch_Allocator_T<ACE_LOCK>::calloc (size_t nbytes,
                                          char initial_value)
{
...
template <class ACE_LOCK> ACE_INLINE void *
ACE_Asynch_Allocator_T<ACE_LOCK>::calloc (size_t,
                                           size_t,
                                           char)
{
  ACE_NOTSUP_RETURN (0);
...
template <class ACE_LOCK> ACE_INLINE void
ACE_Asynch_Allocator_T<ACE_LOCK>::free (void * ptr)
{
...
#endif //ACE_POSIX_AIO_ALLOCATOR_T_C 
