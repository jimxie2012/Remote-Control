...
#ifndef ACE_POSIX_AIO_FD_INFO_H 
#define ACE_POSIX_AIO_FD_INFO_H 
...
class ACE_POSIX_AIO_Emulation_Provider;
class ACE_POSIX_AIO_FD_Info;
class ACE_POSIX_AIO_FD_Repository;
class ACE_POSIX_AIO_Config;

class ACE_POSIX_AIO_LINUX_NAIO_Provider;
...
class ACE_Export ACE_POSIX_AIO_FD_Repository
{
public:
    ...
    {
    public:
        FD_Guard (ACE_POSIX_AIO_FD_Repository & rep,
                  ACE_HANDLE handle,
                  bool flgCreate = true);
        
        ~FD_Guard () {}

        ACE_POSIX_AIO_FD_Info * get_fd_info () const { return fd_info_;}
        
    private:
        ACE_POSIX_AIO_FD_Info  * fd_info_;
    };

    friend class FD_Guard;
    

    ACE_POSIX_AIO_FD_Repository (const ACE_POSIX_AIO_Config & config);
   

    virtual ~ACE_POSIX_AIO_FD_Repository ();
...
private:
    ...
    size_t                   num_slots_;
    Monitor *                array_mon_;
    ACE_POSIX_AIO_FD_Info ** array_info_;
};
 ...
 *
 */
class ACE_Export ACE_POSIX_AIO_FD_Info
{
public:
    ...
    friend  class ACE_POSIX_AIO_Emulation_Provider;
    friend  class ACE_POSIX_AIO_LINUX_NAIO_Provider;
    ...
    ACE_POSIX_AIO_FD_Info (int fd = ACE_INVALID_HANDLE);
    virtual ~ACE_POSIX_AIO_FD_Info(void);
    ...
    //          -1 unable to start
    int   start_read (ACE_POSIX_Asynch_Result * result,
                      FD_Guard & guard,
    ...
    //          > 0 started, return value is interest to declare
    //          -1 unable to start
    int   start_write(ACE_POSIX_Asynch_Result * result,
                      FD_Guard & guard,
                      ACE_POSIX_Asynch_Result_Queue & completed_queue);
    ...
    int   cancel_handler(FD_Guard &  guard,
                         ACE_Handler * handler,
                         ACE_POSIX_Asynch_Result_Queue & canceled_queue);
    ...
    LinkD_T <ACE_POSIX_AIO_FD_Info> * get_link_interest () const;
    LinkD_T <ACE_POSIX_AIO_FD_Info> * get_link_execute () const;
...
private:
    ...
    // TODO: replace later
    ACE_POSIX_Asynch_Result_List& get_read_list ()
      {
        return this->read_op_list_;
      }

    ACE_POSIX_Asynch_Result_List& get_write_list ()
      {
    ...
    int   cancel_list (ACE_POSIX_Asynch_Result_List & pending_list,
                       ACE_POSIX_Asynch_Result_Queue & completed_queue);

    bool  execute_list (FD_Guard&  guard,
                        ACE_POSIX_Asynch_Result_List& list,
                        int ready_bit,
                        int keep_ready_bit,
                        ACE_POSIX_Asynch_Result_Queue & completed_queue);
    ...
    mutable LinkD_T <ACE_POSIX_AIO_FD_Info>  link_interest_;
    mutable LinkD_T <ACE_POSIX_AIO_FD_Info>  link_execute_;
    

    ACE_POSIX_Asynch_Result_List read_op_list_;
    ACE_POSIX_Asynch_Result_List write_op_list_;
...
{
public :
    LinkD_T <ACE_POSIX_AIO_FD_Info> *
        operator ()(const ACE_POSIX_AIO_FD_Info *  x)  const 
    {
...
typedef 
Double_List_T <ACE_POSIX_AIO_FD_Info, FD_Info_Exec_Link>
FD_Info_Exec_List;
...
typedef 
Double_List_T <ACE_POSIX_AIO_FD_Info, FD_Info_Interest_Link>
FD_Info_Interest_List;
//-------------------------------------------------------
//
//-------------------------------------------------------
inline ACE_HANDLE 
ACE_POSIX_AIO_FD_Info::get_handle () const
{
    return this->fd_;
}

inline LinkD_T <ACE_POSIX_AIO_FD_Info> *
ACE_POSIX_AIO_FD_Info::get_link_interest () const
{
    return & this->link_interest_;
}

inline LinkD_T <ACE_POSIX_AIO_FD_Info> *
ACE_POSIX_AIO_FD_Info::get_link_execute () const
{
    return & this->link_execute_;
}

inline int
ACE_POSIX_AIO_FD_Info::get_ready_mask () const
{
    return this->ready_mask_;
}

inline int
ACE_POSIX_AIO_FD_Info::get_active_mask () const
{
    return this->active_mask_;
}

inline void 
ACE_POSIX_AIO_FD_Info::update_ready_mask(int ready_mask)
{
    this->ready_mask_ |= ready_mask;
}

inline void 
ACE_POSIX_AIO_FD_Info::set_active_mask(int active_mask)
{
...
inline int  
ACE_POSIX_AIO_FD_Info::get_interest () const
{
    int  interest = 0;
...
inline bool  
ACE_POSIX_AIO_FD_Info::is_canceled () const
{
    return ACE_BIT_ENABLED(flags_, CANCEL);
}

inline bool  
ACE_POSIX_AIO_FD_Info::is_open_for_read () const
{
    return ACE_BIT_ENABLED(flags_, OPEN_READ);
}

inline bool  
ACE_POSIX_AIO_FD_Info::is_open_for_write () const
{
    return ACE_BIT_ENABLED(flags_, OPEN_WRITE);
}

inline bool  
ACE_POSIX_AIO_FD_Info::is_ready_for_read () const
{
    return ACE_BIT_ENABLED(ready_mask_, READ);
}

inline bool  
ACE_POSIX_AIO_FD_Info::is_ready_for_write () const
{
