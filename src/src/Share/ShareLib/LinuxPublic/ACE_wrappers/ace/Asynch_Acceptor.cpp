...
ACE_Asynch_Acceptor<HANDLER>::open (const ADDRESS& address,
...
template <class HANDLER>
const typename ACE_Asynch_Acceptor<HANDLER>::ADDRESS&
ACE_Asynch_Acceptor<HANDLER>::get_completion_address (
...
ACE_Asynch_Acceptor<HANDLER>::make_handler (const void * /*act*/)
{
  return make_handler();
}
