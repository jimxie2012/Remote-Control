...
#ifndef ACE_ASYNCH_CONNECTOR2_H 
#define ACE_ASYNCH_CONNECTOR2_H 
#include "ace/pre.h"
...
class ACE_Asynch_Connector2 : public ACE_Handler
{
public:
  ...
  ACE_Asynch_Connector2 (void);

  /// Virtual destruction
  virtual ~ACE_Asynch_Connector2 (void);
   ...
   *
   * @retval  -1  ACE_Asynch_Connector2 will close the connection, and
...
#include "ace/Asynch_Connector2.cpp"
