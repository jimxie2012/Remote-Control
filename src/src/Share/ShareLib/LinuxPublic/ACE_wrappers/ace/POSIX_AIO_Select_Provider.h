...
#ifndef ACE_POSIX_AIO_SELECT_PROVIDER_H 
#define ACE_POSIX_AIO_SELECT_PROVIDER_H 
...
/**
 * @class ACE_POSIX_AIO_Select_Provider
 *
 */

class ACE_Export ACE_POSIX_AIO_Select_Provider : 
  public ACE_POSIX_AIO_Emulation_Provider
{

public:

    ACE_POSIX_AIO_Select_Provider (const ACE_POSIX_AIO_Config & config);
    virtual ~ACE_POSIX_AIO_Select_Provider();
...
#endif //ACE_POSIX_AIO_SELECT_PROVIDER_H 
