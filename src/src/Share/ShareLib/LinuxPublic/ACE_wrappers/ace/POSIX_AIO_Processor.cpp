 ...
 *******************************************************************
 */
ACE_POSIX_AIO_Processor::ACE_POSIX_AIO_Processor
...
ACE_POSIX_AIO_Processor::~ACE_POSIX_AIO_Processor (void)
{
    delete provider_;
    this->provider_ = 0;
}
...
bool
ACE_POSIX_AIO_Processor::is_emulation () const
{
    return (config_.provider_class() == 
        ACE_POSIX_AIO_Config::PVC_EMULATION);
}
    
int
ACE_POSIX_AIO_Processor::get_supported_operations_mask () const
{
...
int
ACE_POSIX_AIO_Processor::init (void)
{
    if (this->provider() == 0)
    {
        return -1;
...
int
ACE_POSIX_AIO_Processor::fini (void)
{
    if (this->provider() != 0)
    {
        this->provider()->fini ();
...
int
ACE_POSIX_AIO_Processor::register_handle (ACE_HANDLE handle, 
...
int
ACE_POSIX_AIO_Processor::unregister_handle (ACE_HANDLE handle)
{
    return this->provider()->unregister_handle (handle);
}

int
ACE_POSIX_AIO_Processor::start_aio (ACE_POSIX_Asynch_Result * result)
{
...
int
ACE_POSIX_AIO_Processor::cancel_aio (ACE_HANDLE handle)
{
    ACE_POSIX_Asynch_Result_Queue  completed_queue;
...
int
ACE_POSIX_AIO_Processor::cancel_aio (ACE_Handler * handler)
{
    ACE_POSIX_Asynch_Result_Queue  completed_queue;
...
int
ACE_POSIX_AIO_Processor::cancel_all ()
{
    ACE_POSIX_Asynch_Result_Queue  completed_queue;
...
int
ACE_POSIX_AIO_Processor::get_completed_aio (ACE_Time_Value * wait_time,
               ACE_POSIX_Asynch_Result_Queue & completed_queue)
{
    // do not lock it now
...
bool
ACE_POSIX_AIO_Processor::is_dedicated () const
{
    return false;
}
 
int
ACE_POSIX_AIO_Processor::start (void)
{
    return 0;
}

int
ACE_POSIX_AIO_Processor::stop (void)
{
    return 0;
}

int
ACE_POSIX_AIO_Processor::interrupt (void)
{
 ...
 *******************************************************************
 */
ACE_POSIX_AIO_Dedicated_Processor::ACE_POSIX_AIO_Dedicated_Processor
(ACE_POSIX_AIO_Dispatcher & completion_dispatcher,
   const ACE_POSIX_AIO_Config & config)
: ACE_POSIX_AIO_Processor  (completion_dispatcher, config)
...
bool
ACE_POSIX_AIO_Dedicated_Processor::is_dedicated () const
{
    return true;
}

int 
ACE_POSIX_AIO_Dedicated_Processor::start ()
{
    if (this->activate (THR_NEW_LWP | THR_JOINABLE, 1) != 0)
    {
        ACE_ERROR_RETURN ((LM_ERROR,
            ACE_LIB_TEXT ("%N:%l:%p\n"),
            ACE_LIB_TEXT ("ACE_POSIX_AIO_Dedicated_Processor::start failed")),
            -1);
    }
    return 0;
}
...
int 
ACE_POSIX_AIO_Dedicated_Processor::stop ()
{
    {
    ...
    if (ACE_Task_Base::wait () != 0)
    {
        ACE_ERROR_RETURN ((LM_ERROR,
            ACE_LIB_TEXT ("%N:%l:%p\n"),
            ACE_LIB_TEXT ("ACE_POSIX_AIO_Dedicated_Processor::stop failed")),
            -1);
    }
    return 0;
}
...
int 
ACE_POSIX_AIO_Dedicated_Processor::interrupt ()
{
    // Can not bee called
    ACE_ASSERT(0);
...
int
ACE_POSIX_AIO_Dedicated_Processor::get_completed_aio 
...
int
ACE_POSIX_AIO_Dedicated_Processor::svc ()
{
    ACE_DEBUG ((LM_DEBUG, 
        ACE_TEXT("(%t) ACE_POSIX_AIO_Dedicated_Processor::svc enter\n")));
    ...
    ACE_DEBUG ((LM_DEBUG, 
        ACE_TEXT("(%t) ACE_POSIX_AIO_Dedicated_Processor::svc leave\n")));
    return 0;
}
