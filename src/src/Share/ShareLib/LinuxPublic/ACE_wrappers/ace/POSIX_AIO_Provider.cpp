 ...
 *****************************************************************
 */
ACE_POSIX_AIO_Provider::ACE_POSIX_AIO_Provider
...
/**
 *****************************************************************
 *  ACE_POSIX_AIO_Provider::Notification_Pipe
 *****************************************************************
 */
ACE_POSIX_AIO_Provider::Notification_Pipe::Notification_Pipe 
    (bool flg_nonblock)
: pipe_         ()
...
int 
ACE_POSIX_AIO_Provider::Notification_Pipe::close ()
{
    this->pipe_.close ();
    return 0;
}
...
int 
ACE_POSIX_AIO_Provider::Notification_Pipe::open (bool flg_nonblock)
{
    // Open the pipe.
...
int 
ACE_POSIX_AIO_Provider::Notification_Pipe::notify ()
{
    char char_send = 0;
    ...
    if (rc < 0)
    {
        if (translate_errno() != EWOULDBLOCK)
        {
            ACE_ERROR_RETURN ((LM_ERROR,
                ACE_LIB_TEXT("(%P|%t) ACE_POSIX_AIO_Provider::Notification_Pipe::%p\n"),
...
int 
ACE_POSIX_AIO_Provider::Notification_Pipe::read ()
{
    int rc;
    ...
    {
        ACE_ERROR_RETURN ((LM_ERROR,
            ACE_LIB_TEXT("(%P|%t) ACE_POSIX_AIO_rovider::Notification_Pipe::%p\n"),
...
/*
 ***************************************************************
 *  ACE_POSIX_AIO_Provider::Notification_Result
 ***************************************************************
 */
ACE_POSIX_AIO_Provider::Notification_Result::Notification_Result
    (ACE_POSIX_AIO_Provider::Notification_Pipe & notify_pipe)
: ACE_POSIX_Asynch_Read_Stream_Result 
    (0,       // allocator
     0,       // area
     ACE_Asynch_Read_Stream_Result // original result
       (&notify_pipe,                            // ACE_Hanlder
