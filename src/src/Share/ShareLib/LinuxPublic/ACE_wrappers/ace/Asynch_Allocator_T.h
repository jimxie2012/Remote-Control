...
#ifndef ACE_ASYNCH_ALLOCATOR_T_H 
#define ACE_ASYNCH_ALLOCATOR_T_H 
#include "ace/pre.h"
...
public:
  ACE_Asynch_Allocator_T (size_t chunk_size);

  /// Clear things up.
  ~ACE_Asynch_Allocator_T (void);
...
#include "ace/Asynch_Allocator_T.cpp"
